...
<x-forms.container>
    ...
    >
        <x-search-form :action="route('staff.categories.index')" />
        <div
        ...
        >
            ...
            <x-button href="{{ route('staff.categories.create') }}">
                <svg
                ...
                @forelse ($categories as $category)
                    <tr class="border-b hover:bg-gray-100 dark:border-gray-700">
                        ...
                        <td class="flex items-center justify-end px-4 py-3">
                            <button
                                id="categories-{{ $category->id }}-dropdown-button"
                                data-dropdown-toggle="categories-{{ $category->id }}-dropdown"
