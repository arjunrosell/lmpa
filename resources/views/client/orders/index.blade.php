...
<x-forms.container>
    ...
    >
        ...
        >
            <x-button href="{{ route('client.orders.create') }}">
                <svg
            ...
            <tbody>
                @forelse ($orders as $order)
                    <tr class="border-b dark:border-gray-700">
                        ...
                        >
                            <button
                                id="order-{{ $order->id }}-dropdown-button"
                                data-dropdown-toggle="order-{{ $order->id }}-dropdown"
                            ...
                            <div
                                id="order-{{ $order->id }}-dropdown"
                                class="z-10 hidden w-44 divide-y divide-gray-100 rounded bg-white shadow dark:divide-gray-600 dark:bg-gray-700"
                            >
                                <ul
                                    class="text-sm text-gray-700 dark:text-gray-200"
                                    aria-labelledby="order-{{ $order->id }}-dropdown-button"
                                >
                                    <li>
                                        <a
